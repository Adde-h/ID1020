/*
Adeel Hussain
Generated: 2020-10-05, Updated: 2020-10-07
Dependencies: Graph.java
Input: Graph & Vertex Source
Reference: https://algs4.cs.princeton.edu/41graph/DepthFirstSearch.java.html
*/
...
public class DepthFirstSearch
{
    ...
    //Computes the shortest path to all vertices in Graph (G) using DFS starting from Vertex (s)
    public DepthFirstSearch(Graph G, int s)
    {
        ...
        dfs(G, s);                      //Runs the DFS method to look for the shortest path
    }

    //Iterates through all vertexes and fills the edgeTo array
    private void dfs(Graph G, int v)
    {
        marked[v] = true;               //Sets the vertex (v) to true
